Este projeto implementa uma lixeira automática utilizando o Arduino. A lixeira abre a tampa automaticamente ao detectar a proximidade de uma mão e acende um LED quando a lixeira está cheia.
